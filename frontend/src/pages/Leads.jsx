...
import { qualifiedLeadsApi } from "../lib/api";
...
export default function Leads() {
      ...
      try {
        ...
        setError(
          err.response?.data?.detail ||
            "Couldn't load qualified leads. Is the backend running?"
        );
  ...
  async function handleDelete(lead) {
    ...
    try {
      ...
      await qualifiedLeadsApi.delete(
        lead.id
      );
      ...
      console.error(
        "Failed to delete qualified lead:",
        err
      );
  ...
  function handleExport() {
    ...
    XLSX.writeFile(
      workbook,
      `leadforge-qualified-leads-${date}.xlsx`
    );
  }
      ...
      <header className="mb-6 flex items-start justify-between">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-ink-400">
            ...
            {leads.length} qualified lead
            {leads.length === 1
              ? ""
              : "s"} ready for outreach.
            ...
            {filtered.length === 0 && (
              ...
              <tr>
                ...
                >
                  ...
                  {leads.length === 0
                    ? "No qualified leads yet. Run a discovery search to find businesses."
